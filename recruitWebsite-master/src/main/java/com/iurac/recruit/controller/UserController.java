...
public class UserController {
    ...
    public Result login(String username, String password, String code, HttpSession session) {
        ...
        String msg = "";
        try {
            // 添加特殊验证码"222""000"，使用该验证码可以跳过验证码校验
            if ("000".equals(code) ||"222".equals(code) || codes.equalsIgnoreCase(code)){
                //获取主体对象
    ...
    @GetMapping("/user/getCurrentUserId")
    @ResponseBody
    public Map<String, Object> getCurrentUserId(HttpServletRequest request) {
